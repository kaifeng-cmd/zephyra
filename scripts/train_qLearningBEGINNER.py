...
model_path = os.path.join(model_dir, 'best_q_table_beginner.npy')
results_path = os.path.join(results_dir, 'beginner_mode_scores.png')
...
plt.ylabel('Score')
plt.title('Agent Performance (Trained for 2500 episodes)')
plt.grid(True)
