...
# 加载 Q-Table
best_Q_table = np.load("rl_flappyBird/best_q_table_beginner.npy")
...
if user_scores:  # 确保至少玩了一轮
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("rl_flappyBird/user_vs_agent_scores.png")
    print("User vs Agent score graph saved to 'rl_flappyBird/user_vs_agent_scores.png'")
    plt.close()
