...
# 保存最佳 Q-Table
np.save("rl_flappyBird/best_q_table_hard.npy", best_Q_table)
...
plt.grid(True)
plt.savefig("rl_flappyBird/hard_mode_scores.png")
print("Score graph saved to 'rl_flappyBird/hard_mode_scores.png'")
plt.close()
