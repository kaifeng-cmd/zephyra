...
env = FlappyBirdEnv()
 ...
 # Load Q-Table
best_Q_table = np.load("../models/best_q_table_hard.npy")
...
if user_scores:  # Ensure at least one round played
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("../results/user_vs_agent_scoresHARD.png")
    print("User vs Agent score graph saved to '../results/user_vs_agent_scoresHARD.png'")
    plt.close()
